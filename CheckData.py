...
# uncorrupted and organised correctly
...
# Print update
print('Images are uncorrupted and organised correctly')
...
# Print update
print('Ground-truth segmentations are uncorrupted and organised correctly')
